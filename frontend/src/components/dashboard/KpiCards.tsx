  ...
  const stats = [
    {
      ...
      change: data?.thisMonthApplications ? `${data.thisMonthApplications} this month` : (data?.totalApplications ? 'Active pipeline' : 'No data yet'),
      icon: Mail,
    ...
    },
    {
      ...
      change: data?.thisMonthInterviews ? `${data.thisMonthInterviews} this month` : (data?.interviews ? 'Scheduled' : '0 scheduled'),
      icon: Calendar,
    ...
    },
    {
      ...
      change: data?.thisMonthOffers ? `${data.thisMonthOffers} this month` : (data?.offers ? 'Received' : '0 received'),
      icon: Briefcase,
    ...
    },
    {
      ...
      change: data?.thisMonthRejections ? `${data.thisMonthRejections} this month` : (data?.rejections ? 'Recorded' : '0 recorded'),
      icon: XCircle,
    ...
    },
    {
      ...
      change: data?.totalApplications ? 'From Gmail data' : 'Sync to calculate',
      icon: BarChart3,
